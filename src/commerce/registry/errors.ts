export type RegistrySyncErrorCode =
  ...
  | "REGISTRY_APPLY_PAYLOAD_INVALID"
  | "REGISTRY_APPLY_RESULT_INVALID"
  | "REGISTRY_APPLY_RESULT_CONTEXT_MISMATCH"
  | "REGISTRY_CURRENT_STATE_READ_FAILED"
  | "REGISTRY_CURRENT_STATE_RESPONSE_INVALID"
  | "REGISTRY_CURRENT_STATE_PARENT_UNRESOLVED"
